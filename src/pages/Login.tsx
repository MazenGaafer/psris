...
const Login = () => {
  ...
  const handleEmployeeLogin = async () => {
    ...
    setLoading(true);
    try {
      // ابحث عن الإيميل المرتبط بالرقم الوظيفي
      ...
      if (error || !profile || !profile.email) {
        toast({
          title: "خطأ",
          description: "الرقم الوظيفي غير صحيح أو غير مسجل",
          variant: "destructive"
        });
        setLoading(false);
        return;
      ...
      // استخدم الإيميل المرتبط بالرقم الوظيفي
  ...
  const handleAdminLogin = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // بعد تسجيل الدخول، نتحقق من نوع المستخدم
        ...
        if (user) {
          ...
          if (profileData?.user_type === 'admin') {
            ...
            toast({
              title: "غير مصرح",
              description: "هذا الحساب ليس أدمن",
              variant: "destructive"
            });
  ...
  const userTypes = [
    ...
    },
    {
      id: "admin",
      title: "الأدمن",
      description: "تسجيل دخول الأدمن لإدارة النظام",
      icon: Lock,
      color: "text-paris-red"
    }
  ];
        ...
        <div className="max-w-md mx-auto">
          ...
          <Tabs value={loginType} onValueChange={setLoginType} className="space-y-6">
            ...
            <TabsContent value="admin">
              <Card className="card-shadow">
                <CardHeader className="text-center">
                  <CardTitle className="text-xl">تسجيل دخول الأدمن</CardTitle>
                  <CardDescription>
                    دخول خاص بمسؤولي النظام فقط
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                  ...
                  <Button
                    ...
                    disabled={loading}
                  >
                    {loading ? "جاري تسجيل الدخول..." : "دخول الأدمن"}
          ...
          <div className="text-center mt-8 text-sm text-muted-foreground">
            <p>© ٢٠٢٤ مركز باريس - محافظة الوادي الجديد </p>
