      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">معلومات التواصل</h2>
            <p className="text-lg text-muted-foreground">طرق متعددة للتواصل معنا</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((contact, index) => (
              <Card key={index} className="text-center card-shadow hover:card-shadow-hover transition-all duration-300">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-xl font-bold text-foreground mb-2">{contact.value}</p>
              ...
              <Card className="card-shadow">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">مركز باريس، محافظة كفر الشيخ</p>
